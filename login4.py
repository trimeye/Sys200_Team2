...
for i in range (5,0, -1):
    ...
    p = getpass()
    #print(i) 
    try: loginDict.get(x) and loginDict[x] == p:print("access GRANTED!!!")
        #print(i)exit()
    except: i != 1:        print("something is not correct, try again", i-1 , "attempts left")
    else:
